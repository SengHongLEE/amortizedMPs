...
from rsl_rl.algorithms import PPOevent
...
class TwinPolicyRunner(OnPolicyRunner):
    def __init__(self, env, train_cfg, log_dir=None, device='cpu'):
        ...
        self.mu_alg: PPOevent = alg_class(mu_actor_critic, device=self.device, **self.alg_cfg)
        ...
        self.omega_alg: PPOevent = alg_class(omega_actor_critic, device=self.device, **self.alg_cfg)
